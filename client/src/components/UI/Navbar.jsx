    ...
    <nav className="bg-base-100 shadow-md sticky top-0 z-50 backdrop-blur-md bg-opacity-90 transition-colors duration-300">
      <div className="container">
        ...
        <div className="flex items-center gap-3">
          <NavLink
            to="/"
            className="text-3xl font-extrabold text-transparent bg-clip-text bg-gradient-to-r from-yellow-400 via-orange-500 to-black hover:brightness-110 transition-all duration-300"
          >
            Belsy Restaurant
          </NavLink>
          <ThemeToggle />
          ...
          {isLoggedIn ? (
            <>
              <button
                ...
                className="btn btn-ghost btn-sm md:btn-md px-4 rounded-md text-primary hover:bg-primary/10 focus:outline-none focus:ring-2 focus:ring-primary focus:ring-offset-1 transition md:text-lg"
              >
                Logout
              </button>
            </>
